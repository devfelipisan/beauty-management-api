...
const APPOINTMENT_TRANSITIONS = {
  awaiting_deposit: { deposit_confirmed: "awaiting_confirmation", expire_deposit: "expired", cancel: "canceled" },
  awaiting_confirmation: { confirm_presence: "confirmed", reschedule: "rescheduled", cancel: "canceled" },
  confirmed: { check_in: "checked_in", start_session: "in_progress", reschedule: "rescheduled", cancel: "canceled", mark_no_show: "no_show" },
  checked_in: { start_session: "in_progress", cancel: "canceled" },
